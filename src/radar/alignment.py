...
def build_argparser():
    ...
    p.add_argument("--target_domain", type=str, default="10x 3' v2")
    ...
    p.add_argument("--lr_g", type=float, default=2.0e-4)
    p.add_argument("--lr_d", type=float, default=2.0e-4)
    ...
    p.add_argument("--d_dropout", type=float, default=0.1)
    p.add_argument("--use_change_gate", action="store_true")
    p.add_argument("--lambda_batch", type=float, default=3.0)
    p.add_argument("--lambda_state", type=float, default=0.2)
    p.add_argument("--lambda_rec", type=float, default=2.0)
    p.add_argument("--lambda_id", type=float, default=0.4)
